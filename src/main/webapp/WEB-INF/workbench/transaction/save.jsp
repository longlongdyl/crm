...
<body>
	...
	<form id="tranForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input name="customerId" type="text" class="form-control" id="create-accountName"  placeholder="支持自动补全，输入客户不存在则新建">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId"  id="acid" value="">
			</div>
		</div>
...
<script>
	...
	$('#saveTran').click(function () {
		...
		$.ajax({
			...
			success :function (data) {
				location.href = "/crm/toView/workbench/transaction/index"
			}
		})
	});
	...
	function activityId(momo){
		 $('#create-activitySrc').val(momo.parent().next().html());
	     $('#acid').val(momo.val());
    	 $('#findMarketActivity').modal('hide');
	}

	function contactsId(momo){
		$('#create-contactsName').val(momo.parent().next().html());
