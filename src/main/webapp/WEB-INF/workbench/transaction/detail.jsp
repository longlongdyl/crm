		...
		<c:forEach items="${caChes}" var="caChe">
			<c:if test="${caChe.code == 'stage'}">
				<c:forEach items="${caChe.caCheValueList}" var="caCheValue">
					...
					<span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom" data-content="${caCheValue.value}" style="color: #90F790;"></span>
					-----------
					</c:if>
					<c:if test="${caCheValue.value == tran.stage}">
						<span class="glyphicon glyphicon-map-marker mystage" data-toggle="popover" data-placement="bottom" data-content="${caCheValue.value}" style="color: #90F790;"></span>
						-----------
					</c:if>
					<c:if test="${caCheValue.value > tran.stage}">
						<span class="glyphicon glyphicon-record mystage" data-toggle="popover" data-placement="bottom" data-content="${caCheValue.value}"></span>						-----------
					</c:if>
				</c:forEach>
			</c:if>
		</c:forEach>
