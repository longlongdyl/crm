                    ...
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="width: 300px;"
                                   placeholder="请输入市场活动名称，支持模糊查询" onclick="queryActivity($(this).val())">
...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default"
                onclick="location.href='/crm/workbench/clue/convert?clueId='+'${clue.id}';"><span
            ...
            <table class="table table-hover" style="width: 900px;">
                ...
                <c:forEach items="${clue.activities}" var="activity">
                    <tr id="${activity.id}">
                        ...
                        <td><a href="javascript:void(0);" onclick="deleteActivity('${activity.id}')"
...
<script>
    function deleteActivity(id) {
        $.ajax({
            url: '/crm/workbench/clue/deleteActivity',
            data: {'id': id},
            type: 'post',
            dataType: 'json',
            success: function (data) {
