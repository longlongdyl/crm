...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='/crm/toView/workbench/clue/convert';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<div class="remarkDiv" style="height: 60px;">
			<img title="${clue.fullname}" src="/crm/image/user-thumbnail.png" style="width: 30px; height:30px;">
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5 id="${clueRemark.id}">${clueRemark.noteContent}</h5>
				<font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullname}-${clue.company}</b> <small style="color: gray;">${clueRemark.createTime} 由${clueRemark.createBy}</small>
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
					<a class="myHref" href="javascript:void(0);"><span onclick="updateClueRemark('${clueRemark.id}')" class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
			...
			$.ajax({
				...
				success :function (data){
					...
					$('#div1').prepend("<link href=\"/crm/jquery/bootstrap_3.3.0/css/bootstrap.min.css\" type=\"text/css\" rel=\"stylesheet\" />"+
							...
							"\n" +
							"\t\t\t\t <div style=\"position: relative; top: -40px; left: 40px;\" >\n" +
							"\t\t\t\t\t <h5 id=\"${clueRemark.id}\">"+$('#remark').val()+"</h5>\n" +
							"\t\t\t\t\t <font color=\"gray\">线索</font> <font color=\"gray\">-</font> <b>${clue.fullname}-${clue.company}</b> <small style=\"color: gray;\">"+onedate+"由${user.name}</small>\n" +
							"\t\t\t\t </div>\n" +
							"\t\t\t </div>");
					$('#remark').val('');
				}
